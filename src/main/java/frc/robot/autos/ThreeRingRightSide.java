        ...
        public ThreeRingRightSide(SwerveDrive swerve, RotatorSubsystem rotator, ShooterSubsystem shooter,
                ...
                addCommands(new InstantCommand(() -> swerve.setInitialPose("right ring")),
                                ...
                                new ParallelCommandGroup(
                                                swerve.followPathCommand(PathPlannerPath.fromPathFile("right ring")),
                                                new StowPreset(rotator, shooter)),
                                new WaitCommand(0.1),
                                swerve.followPathCommand(PathPlannerPath.fromPathFile("shoot right first ring")),
                                new ReadyShooter(shooter, rotator, intake, () -> swerve.getDistanceMetersToGoal())
                                                .withTimeout(2),
                                new RunCommand(() -> intake.setIntakeSpeed(1), intake).withTimeout(0.5),
                                ...
                                new ParallelCommandGroup(
                                                swerve.followPathCommand(
                                                                PathPlannerPath.fromPathFile("pickup middle ring 4")),
                                                new InstantCommand(() -> intake.setIntakeSpeed(1)),
                                                new StowPreset(rotator, shooter)),
