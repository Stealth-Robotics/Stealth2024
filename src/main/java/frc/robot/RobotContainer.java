...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        new Trigger(driverController.leftBumper())
                .onTrue(new ReadyShooter(shooter, rotatorSubsystem, intake, swerveSubsystem, distanceToShotValuesMap,
                        1.4))
                .onFalse(new AimAndShootCommand(swerveSubsystem, rotatorSubsystem, shooter, intake,
                        ...
                        .andThen(new ScheduleCommand(new StowPreset(rotatorSubsystem, shooter))));
        ...
        new Trigger(driverController.y()).onTrue(
                new AimAndShootCommand(swerveSubsystem, rotatorSubsystem, shooter, intake, distanceToShotValuesMap,
                        1.4));
